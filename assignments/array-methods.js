...
ticketPriceTotal = runners.reduce((total, tickets) =>{
...
//Director wants all the emails of all the runners
const emails = runners.map( email =>{
    return email.email;
})
...
// Problem 2
//Director wants all the information of the runners shirt sizes that arent Medium
let noMedium = runners.filter(med => med.shirt_size != 'M');
console.log(noMedium)
